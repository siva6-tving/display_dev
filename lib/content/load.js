...
const kboTeams = {
	...
	"LT": ["#041E42", "https://image.tving.com/ntgs/sports/kbo/team/20240304/LT.svg", "https://image.tving.com/ntgs/operation/banner/2024/05/22/1716358731_1.jpg", "롯데"],
	...
	"SK": ["#CF0022", "https://image.tving.com/ntgs/sports/kbo/team/20240304/SK.svg", "https://image.tving.com/ntgs/operation/banner/2024/05/22/1716359047_1.jpg", "SSG"],
	"SS": ["#005BAC", "https://image.tving.com/ntgs/sports/kbo/team/20240304/SS.svg", "https://image.tving.com/ntgs/operation/banner/2024/05/22/1716358928_1.jpg", "삼성"],
...
$('#top-gnb').ready(()=>{
	_.each(findLocationInfo(LOC, location), v=>{
		...
		$('.warnning').css('margin-left', $('header > aside').length?'20pt':'auto').css('background-color', v.color).on('click', () => {
			const myTeamCode = getMyTeamCode($('img[alt^="my-team-emblem"]').attr('src'));
